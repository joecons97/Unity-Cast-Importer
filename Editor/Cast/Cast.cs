///
/// Thanks to dtzxporter for the data structures
/// All code below is under MIT License (see repo for details)
/// Cast repo: https://github.com/dtzxporter/cast
///
...
namespace CastImporter.Editor.Cast
{
    ...
    public class Mesh : CastNode
    {
        ...
        public int UVLayerCount()
        {
            ...
            {
                return Convert.ToInt32(Value.Values[0]);
            }
    ...
    public class Animation : CastNode
    {
        ...
        public bool Looping()
        {
            ...
            {
                return Convert.ToUInt32(Value.Values[0]) >= 1;
            }
